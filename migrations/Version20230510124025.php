 ...
 */
final class Version20230510124025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE days ADD CONSTRAINT FK_EBE4FC6665B49873 FOREIGN KEY (exercise_set_id) REFERENCES exercise_set (id)');
