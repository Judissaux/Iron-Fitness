 ...
 */
final class Version20230413123306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercise_set (id INT AUTO_INCREMENT NOT NULL, exercise_id INT DEFAULT NULL, program_id INT DEFAULT NULL, repetition INT DEFAULT NULL, rest INT DEFAULT NULL, series INT DEFAULT NULL, duration INT DEFAULT NULL, INDEX IDX_704B80A0E934951A (exercise_id), INDEX IDX_704B80A03EB8070A (program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE exercise_set ADD CONSTRAINT FK_704B80A0E934951A FOREIGN KEY (exercise_id) REFERENCES exercises (id)');
